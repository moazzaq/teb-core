    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('user', function (User $user) {
                return view('admin.users.columns._user', compact('user'));
            })
            ->editColumn('created_at', function (User $user) {
                return $user->created_at->format('d M Y, h:i a');
            })
            ->addColumn('action', function (User $user) {
                return view('admin.users.columns._actions', compact('user'));
            })
            ->setRowId('id');
    }
...
//                Button::make('reload'),
            ...
            ->drawCallback("function() {"
                . file_get_contents(resource_path('views/admin/users/columns/_draw-scripts.js')) .
                "}");
//        return $this->builder()
//
//            ->setTableId('users-table')
...
//            ]);
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('email')->title('Email')->searchable(true)->hidden()
